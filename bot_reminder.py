...
# ─── KONFIGURASI ───────────────────────────────────────────────
# Token & Chat ID diambil dari Environment Variables di Railway
# (Tab "Variables" -> tambahkan BOT_TOKEN dan CHAT_ID)
...
if not TOKEN:
    raise RuntimeError(
        "BOT_TOKEN belum di-set! Tambahkan di Railway > Variables > BOT_TOKEN"
    )
if not CHAT_ID:
    raise RuntimeError(
        "CHAT_ID belum di-set! Tambahkan di Railway > Variables > CHAT_ID"
    )
# ───────────────────────────────────────────────────────────────
